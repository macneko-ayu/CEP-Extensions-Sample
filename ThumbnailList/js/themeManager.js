...
var themeManager = (function () {
    ...
    function updateThemeWithAppSkinInfo(appSkinInfo) {
        ...
        addRule(styleId, "body", "font-size:" + "12px;");
        addRule(styleId, "body", "font-family:" + 'helvetica, arial, "hiragino kaku gothic pro", meiryo, "ms pgothic", sans-serif');
...
//        addRule(styleId, "body", "font-family:" + appSkinInfo.baseFontFamily);
        ...
        addRule(styleId, "button", "font-size:" + "12px;");
        addRule(styleId, "button", "font-family:" + 'helvetica, arial, "hiragino kaku gothic pro", meiryo, "ms pgothic", sans-serif');
        ...
        addRule(styleId, "input", "font-size:" + "12px;");
        addRule(styleId, "input", "font-family:" + 'helvetica, arial, "hiragino kaku gothic pro", meiryo, "ms pgothic", sans-serif');
